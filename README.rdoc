...
This gem is useful when you want to navigate through your records by year, month or day - for example, at news archive page.
...
The news model will get following scopes:
